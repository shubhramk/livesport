...
////////////////////////////////////
     ...
     *
     * # ng (core modules)
     * The ng modules is loaded by default when an AngularJS application is started. The modules itself
     * contains the essential components for an AngularJS application to function. The table below
     * lists a high level breakdown of each of the services/factories, filters, directives and testing
     * components available within this core modules.
     *
     * <div doc-modules-components="ng"></div>
     */
...
/////////////////////////////////////////////////
     ...
     *
     * <example name="multi-bootstrap" modules="multi-bootstrap">
     * <file name="index.html">
     ...
     * var app = angular.modules('multi-bootstrap', [])
     *
...
//TODO(misko): this function needs to be removed
    ...
    function setupModuleLoader(window) {
        ...
        return ensure(angular, 'module', function() {
             ...
             * # Module
             *
             * A modules is a collection of services, directives, controllers, filters, and configuration information.
     ...
     * }]);
             ...
             *        unspecified then the modules is being retrieved for further configuration.
                ...
                return ensure(modules, name, function() {
                    if (!requires) {
                        throw $injectorMinErr('nomod', "Module '{0}' is not available! You either misspelled " +
                            "the modules name or forgot to load it. If registering a modules ensure that you " +
 ...
 *   }]);
     ...
     *
     * @example
     <example modules="cacheExampleApp">
     <file name="index.html">
     ...
     <file name="script.js">
     angular.modules('cacheExampleApp', []).
 ...
 * }
     ...
     * </div>
     *
     <example modules="compileExample">
     <file name="index.html">
     <script>
     angular.modules('compileExample', [], function($compileProvider) {
 ...
 *     });
     ...
     *
     * @example
     <example modules="documentExample">
     <file name="index.html">
     <div ng-controller="ExampleController">
     ...
     <file name="script.js">
     angular.modules('documentExample', [])
 ...
 * $httpBackend} which can be trained with responses.
     ...
     *
     * @example
     <example modules="customInterpolationApp">
     <file name="index.html">
     <script>
   ...
   *
    ...
    function $IntervalProvider() {
        this.$get = ['$rootScope', '$window', '$q',
            function($rootScope,   $window,   $q) {
                 ...
                 *
                 * @example
                 * <example modules="intervalExample">
                 * <file name="index.html">
                 *   <script>
                 *     angular.modules('intervalExample', [])
     ...
     *
     * @example
     <example modules="logExample">
     <file name="script.js">
     angular.modules('logExample', [])
 ...
 * them} or {@link ng.$sce#trustAsResourceUrl wrap it} into a trusted value.
     ...
     * | Context             | Notes          |
     * |---------------------|----------------|
     * | `$sce.HTML`         | For HTML that's safe to source into the application.  The {@link ng.directive:ngBindHtml ngBindHtml} directive uses this context for bindings. If an unsafe value is encountered and the {@link ngSanitize $sanitize} modules is present this will sanitize the value instead of throwing an error. |
...
// service.
     ...
     *
     * @example
     <example modules="windowExample">
     <file name="index.html">
     <script>
     angular.modules('windowExample', [])
 ...
 *     });
     ...
     * @example
     <example name="$filter" modules="filterExample">
     <file name="index.html">
     ...
     *
     * @example
     <example modules="currencyExample">
     <file name="index.html">
     <script>
     angular.modules('currencyExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     *
     * @example
     <example modules="numberFilterExample">
     <file name="index.html">
     <script>
     angular.modules('numberFilterExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     *
     * @example
     <example modules="limitToExample">
     <file name="index.html">
     <script>
     angular.modules('limitToExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     *
     * @example
     <example modules="orderByExample">
     <file name="index.html">
     <script>
     angular.modules('orderByExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
             $scope.friends =
...
//asks for $scope to fool the BC controller modules
     ...
     *
     * <pre>
     * //be sure to include ngAnimate as a modules to hook into more
     * //advanced animations
     * .my-form {
 ...
 * }
     ...
     *
     * @example
     <example deps="angular-animate.js" animations="true" fixBase="true" modules="formExample">
     <file name="index.html">
     <script>
     angular.modules('formExample', [])
    ...
    var inputType = {
         ...
         *
         * @example
         <example name="text-input-directive" modules="textInputExample">
         <file name="index.html">
         <script>
         angular.modules('textInputExample', [])
         .controller('ExampleController', ['$scope', function($scope) {
               $scope.text = 'guest';
               $scope.word = /^\s*\w*\s*$/;
             }]);
         ...
         *
         * @example
         <example name="number-input-directive" modules="numberExample">
         <file name="index.html">
         <script>
         angular.modules('numberExample', [])
         .controller('ExampleController', ['$scope', function($scope) {
               $scope.value = 12;
             }]);
         </script>
         ...
         *
         * @example
         <example name="url-input-directive" modules="urlExample">
         <file name="index.html">
         <script>
         angular.modules('urlExample', [])
         .controller('ExampleController', ['$scope', function($scope) {
         ...
         *
         * @example
         <example name="email-input-directive" modules="emailExample">
         <file name="index.html">
         <script>
         angular.modules('emailExample', [])
         .controller('ExampleController', ['$scope', function($scope) {
         ...
         *
         * @example
         <example name="radio-input-directive" modules="radioExample">
         <file name="index.html">
         <script>
         angular.modules('radioExample', [])
         .controller('ExampleController', ['$scope', function($scope) {
               $scope.color = 'blue';
               $scope.specialValue = {
                 "id": "12345",
         ...
         *
         * @example
         <example name="checkbox-input-directive" modules="checkboxExample">
         <file name="index.html">
         <script>
         angular.modules('checkboxExample', [])
         .controller('ExampleController', ['$scope', function($scope) {
               $scope.value1 = true;
               $scope.value2 = 'YES'
             }]);
...
// Pass validity so that behaviour can be mocked easier.
     ...
     *
     * @example
     <example name="input-directive" modules="inputExample">
     <file name="index.html">
     <script>
     angular.modules('inputExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
 ...
 * }
     ...
     * modules to automatically remove "bad" content like inline event listener (e.g. `<span onclick="...">`).
     * However, as we are using `$sce` the model can still decide to provide unsafe content if it marks
     * that content using the `$sce` service.
     *
     * <example name="NgModelController" modules="customControl" deps="angular-sanitize.js">
     <file name="style.css">
     [contenteditable] {
     ...
     <file name="script.js">
     angular.modules('customControl', ['ngSanitize']).
 ...
 * }
     ...
     *
     * @example
     * <example deps="angular-animate.js" animations="true" fixBase="true" modules="inputExample">
     <file name="index.html">
     <script>
     angular.modules('inputExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     *
     * @example
     * <example name="ngChange-directive" modules="changeExample">
     *   <file name="index.html">
     *     <script>
     *       angular.modules('changeExample', [])
     *         .controller('ExampleController', ['$scope', function($scope) {
 *           $scope.counter = 0;
 ...
 *     });
     ...
     *
     * @example
     <example name="ngList-directive" modules="listExample">
     <file name="index.html">
     <script>
     angular.modules('listExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     *
     * @example
     <example name="ngValue-directive" modules="valueExample">
     <file name="index.html">
     <script>
     angular.modules('valueExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     * Enter a name in the Live Preview text box; the greeting below the text box changes instantly.
     <example modules="bindExample">
     <file name="index.html">
     <script>
     angular.modules('bindExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
             $scope.name = 'Whirled';
           }]);
     </script>
     ...
     * core Angular). In order to use {@link ngSanitize} in your modules's dependencies, you need to
     ...
     * @example
     ...
     <example modules="bindHtmlExample" deps="angular-sanitize.js">
     <file name="index.html">
     <div ng-controller="ExampleController">
     ...
     <file name="script.js">
     angular.modules('bindHtmlExample', ['ngSanitize'])
     .controller('ExampleController', ['$scope', function($scope) {
           $scope.myHTML =
     ...
     * @example Example that demonstrates basic bindings via ngClass directive.
     ...
     <example modules="ngAnimate" deps="angular-animate.js" animations="true">
     <file name="index.html">
 ...
 * }
     ...
     *
     * <example name="ngControllerAs" modules="controllerAsExample">
     *   <file name="index.html">
     ...
     *   </file>
     *   <file name="app.js">
     *    angular.modules('controllerAsExample', [])
 ...
 *     });
     ...
     *
     * <example name="ngController" modules="controllerExample">
     *  <file name="index.html">
     ...
     *  </file>
     *  <file name="app.js">
     *   angular.modules('controllerExample', [])
...
// so that they are not executed in an inconsistent state.
     ...
     *
     * @example
     <example modules="submitExample">
     <file name="index.html">
     <script>
     angular.modules('submitExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
            $scope.list = [];
            $scope.text = 'hello';
 ...
 *                  $anchorScroll} to scroll the viewport after the content is loaded.
     ...
     *
     * @example
     <example modules="includeExample" deps="angular-animate.js" animations="true">
     <file name="index.html">
     <div ng-controller="ExampleController">
     ...
     <file name="script.js">
     angular.modules('includeExample', ['ngAnimate'])
     .controller('ExampleController', ['$scope', function($scope) {
          $scope.templates =
...
// is called.
     ...
     *
     * @example
     <example modules="initExample">
     <file name="index.html">
     <script>
     angular.modules('initExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
         $scope.list = [['a', 'b'], ['c', 'd']];
       }]);
     </script>
 ...
 *                      'other': '{{person1}}, {{person2}} and {} other people are viewing.'}">
     ...
     *
     * @example
     <example modules="pluralizeExample">
     <file name="index.html">
     <script>
     angular.modules('pluralizeExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
              $scope.person1 = 'Igor';
              $scope.person2 = 'Misko';
              $scope.personCount = 1;
 ...
 * }
     ...
     *
     * @example
     <example modules="switchExample" deps="angular-animate.js" animations="true">
     <file name="index.html">
     <div ng-controller="ExampleController">
     ...
     <file name="script.js">
     angular.modules('switchExample', ['ngAnimate'])
     .controller('ExampleController', ['$scope', function($scope) {
     ...
     *
     * @example
     <example modules="transcludeExample">
     <file name="index.html">
     <script>
     angular.modules('transcludeExample', [])
     ...
     *
     * @example
     <example modules="selectExample">
     <file name="index.html">
     <script>
     angular.modules('selectExample', [])
     .controller('ExampleController', ['$scope', function($scope) {
            $scope.colors = [
